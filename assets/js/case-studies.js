...
window.CASE_STUDIES = {
  ...
  'leadcraft': {
    ...
    body: [
      ...
      '<p><strong>Product definitions calcify.</strong> The "ideal customer" wasn\'t wrong so much as incomplete, and the incomplete version was costing us a growth segment. The hardest part of the work was updating a belief, not a screen.</p>',
